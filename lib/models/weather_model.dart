...
//gelen veriyi direkt değişkene koy demek için this. kullanıyorum
 ...
 // Factory Constructor: JSON verisini alıp Model nesnesine çeviren yapı ( swift'teki 'Decoder' burada manuel yapılıyor.)
  factory WeatherModel.fromJson(Map<String, dynamic> json) { // dynamic herhangi bir tip olabilir demek (any gibi)
    return WeatherModel(
      cityName: json['name'],

      //API'den gelen sıcaklık eğer tam sayı (int) olmazsa diye önce 'num' olarak alıp 'double'a çevirmeliyim
      temperature: (json['main']['temp'] as num ).toDouble(), // swiftte noktayla yapılırdı dartta etiketle yapılıyor bunu unutma json.main.temp --> json['main']['temp']
